    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar style={{display: 'flex', justifyContent: 'space-between'}}>
          ...
          <img src={logo} alt="logo" style={{ height: '40px', marginBottom: '5px', marginRight:"5%" }} onClick={handleLogoClick}/>
          <div className='searchVideo'>                 
            <input className="uk-search-input" type="search" placeholder="Search" aria-label="" style={{borderBottom:"1px solid", padding:"5px", width:"60%"}}/>
          </div>
          <div style={{display:"inline-flex", alignItems:"center"}}>
            <Button onClick={handleOpen} style={{background:"none",border:"none"}}>
              <NotificationsNoneIcon style={{ fontSize:"40px", marginRight:"10px",color:"black"}}/>
            </Button>           
